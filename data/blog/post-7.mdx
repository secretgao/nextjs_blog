...
slug: post-7
author: secretgao：https://github.com/secretgao
tags: ["blog","教程"]
---

> 本文详细介绍了如何使用Next.js、GitHub Issues和Vercel从零开始构建并部署个人博客。包含技术栈选择、需求分析、开发过程和部署步骤等完整指南。

大家好，我是红鲤鱼与绿鲤鱼与驴，今天来分享我最近从 0 到 1 开发的 个人blog，

红鲤鱼与绿鲤鱼与驴的博客：https://www.红鲤鱼与绿鲤鱼与驴.cn/
...
- [x] 支持 RSS ，Robots，sitemap.xml
  ...
  >  以上代码 commit：https://github.com/secregao/blog/commits/main/
...
3. 全局搜索 红鲤鱼与绿鲤鱼与驴 不要限制大小写，替换为自己的名称
...
---
此文自动发布于：<a href="https://github.com/secregao/blog/issues/7" target="_blank">github issues</a>
